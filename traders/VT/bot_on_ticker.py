...
bot_on_ticker = {
    ...
    #+9 +7 -3 !(29%) +0.6 +1.3 +1.6 +4.3 +3.7 +28.1 -5.4 +4
    ...
    #20.09.26 +5.1 -1.9 +2.9
    'ROSN':(UEG6_ADVENTURE,(None,None,30,47,16,2.5,0),1,None),
    #06.09.26 +0.4 -1.2 +3 +4.4 +1.2 +4.8 -1 +6.3
