...
bot_on_ticker = {
    ...
    'ALRS':(WEG7_PARADOX,(20,19,28,1.4,),2,None), #-10 пиздец
    'ALRS2':(UEG6_VULTURE,(20,15,50,55,43,30,4,5,0.28,15,),2,None), #+0
    'MAGN':(WEG4_DOG,(39,59,4,26,),5,None), #-2
    'MAGN2':(LEG2_DRINKER,(39,75,46,2.7,4,23,11,1,),6,None),#-5

    'IRAO':(LEG1_IRONANNY,(41,57,10,3,55,7,),5,None), #-5
    'IRAO2':(PEG17_PHOENIX,(49,49,27,9,16,41,15,1,55,),4,None), #+4
    'MTLR':(UEG4_FALCON,(33,75,4,2,0.32,),6,None), #+10
    'MTLR2':(WEG3_DS,(37,49,44,),4,None), #0

    'RUAL':(PEG18_BLAZE,(49,91,24,4,49,34,37,0,55,),7,None), #+1
    'RUAL2':(PEG4_U3,(46,96,44,21,2,55,'BB','mfi',),7,None), #+0
    'VTBR':(PEG11_KUSURUKEN,(109,213,23,6,23,15,'hl',55,),16,None), #+3
    'VTBR2':(LEG2_FENNEC,(97,157,30,2.0,5,38,14,0.6,0,),11,None), #+3

    'ASTR':(WEG4_DOG,(39,78,7,30,),6,None), #+0
    'ASTR2':(LEG2_DRINKER,(34,68,23,2.9,6,31,17,1,),5,None), #+9
    'ROSN':(PEG4_UNIVERSAL,(66,47,27,5,35,12,'DC','mfi',4,),5,None), #-3
    'ROSN2':(UEG8_AVENGER,(61,116,19,0.0,1.0,1.0,9.5,0,),9,None), #-2

    'SBER':(LEG1_PIN,(209,338,5,16,23,4,),25,None), #+1
    'SBER2':(PEG14_RENEGADE,(267,440,16,39,48,18,28,54,),32,None), #+0
    'SIBN':(LEG1_PHOGA,(85,173,3,1.1,7,),14,None), #-7
    'SIBN2':(PEG26_UNKNOWN,(86,173,54,42,27,37,29,9,15,55,0,),14,None), #-4

    'SNGSP':(PEG4_UNIVERSAL,(78,128,31,27,43,8,'VC','s',6,),10,None), #-3
    'SNGSP2':(LEG1_CC,(51,97,16,5,55,10,53,1.1,0,1,),7,None), #-2
