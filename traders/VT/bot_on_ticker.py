...
bot_on_ticker = {
    ...
    #+1 +10 +10 !(35%) +0.4 +3.7 +2.4 -2.2 -0.5 +0.2
    ...
    #+9 +7 -3 !(29%) +0.6 +1.3 +1.6 +4.3 +3.7 +28.1
    ...
    #06.09.26 +0.4 -1.2 +3 +4.4 +1.2 +4.8
    ...
    #+5 +9 +11 !(14%) +3.4 -2.2 +7.6 -2.2 +0 -6.5
