...
bot_on_ticker = {
    ...
    #+1 +10 +10 !(35%) +0.4 +3.7 +2.4 -2.2 -0.5 +0.2 +1.8
    ...
    #20.09.26
    'ASTR':(VEG1_VENUS,(None,None,0.3,0.6,0.2,0.7,1,0,0),1,None),
    #20.09.26 +2.4 +3.2
    ...
    #+9 +7 -3 !(29%) +0.6 +1.3 +1.6 +4.3 +3.7 +28.1 -5.4
    ...
    #06.09.26 +0.4 -1.2 +3 +4.4 +1.2 +4.8 -1
    ...
    #+5 +9 +11 !(14%) +3.4 -2.2 +7.6 -2.2 +0 -6.5 -2.7
