...
bot_on_ticker = {
    ...
    #+9 +7 -3 !(29%) +0.6 +1.3 +1.6 +4.3 +3.7 +28.1 -5.4 +4 -7.2
    'MTLR':(PEG11_KUSURUKEN,(None,None,44,8,51,36,'c',55),1,None), 
    #20.09.26 +8 +6 +2.2 +2.2
